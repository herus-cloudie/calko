                ...
                <div id="pagee" className="clearfix">
                    ...
                    <div className="mobile-menu">
                        ...
                        <nav className="menu-box">
                            <div className="nav-logo"><Link href="/"><img src="https://calko.ir/wp-content/uploads/elementor/thumbs/Asset-17@4x-min-quac9v47ns9p1g67ip2hd8vziq0ivet5zgevnmnv9c.png" alt width={140} height={140} /></Link></div>
                    ...
                    <div className="left-menu">
                        ...
                        <div id="sidebar-menu">
                            ...
                            <div className="logo-box d-flex">
                                <div className="logo">
                                    <Link href="/">
                                        <img src="/assets/images/logo/logo3@2x.png" alt width={140} height={140} className="img-logo" />
